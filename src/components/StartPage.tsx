            ...
            <div className=" w-full h-7/12 justify-center flex">
              <div className=" w-1/2 h-2/12 ">
                ...
                <div className=" w-full h-full flex text-center justify-center lg:pt-1 animate-icons opacity-0 pt-12">
                  <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/mihai-trif-609a2a297/">
                    <FaLinkedin size={30} className=" hover:scale-120 transition-transform animate-icon1" />
                  </a>
