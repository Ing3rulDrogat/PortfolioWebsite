    ...
    <div className="w-screen h-screen bg-teal-900  flex items-center">
      <div className=" h-9/12 w-full flex flex-wrap">
        <div className=" h-1/2 w-1/2 ">
          ...
          <p className="pl-14">
            Current technologies which I have experience in and will continuenly
            use
          </p>
        </div>
        <div className=" h-1/2 w-1/2 flex flex-wrap pl-10">
          <div className="bg-teal-950 rounded-2xl shadow-sm shadow-green-300 w-1/12 h-1/4 ml-10 ml-10 flex text-center justify-center flex-wrap pt-1 hover:shadow-lg cursor-pointer">
            <FaReact size={50} />
            <p className="text-[13px]">React</p>
          </div>
          <div className="bg-teal-950 rounded-2xl shadow-sm shadow-green-300 w-1/12 h-1/4 ml-10 flex text-center justify-center flex-wrap pt-1 hover:shadow-lg cursor-pointer">
            <SiNextdotjs size={50} />
            <p className="text-[13px]">Next.js</p>
          </div>
          <div className="bg-teal-950 rounded-2xl shadow-sm shadow-green-300 w-1/12 h-1/4 ml-10 flex text-center justify-center flex-wrap pt-1.5 hover:shadow-lg cursor-pointer">
          ...
          <div className="bg-teal-950 rounded-2xl shadow-sm shadow-green-300 w-1/12 h-1/4 ml-10 flex items-center flex-col  pt-1 hover:shadow-lg cursor-pointer">
            <FaGitAlt size={50} />
        ...
        <div className="h-1/2 w-1/2">
          ...
          <p className="pl-14">
            Technologies that I will learn in the future to expand my knowledge
            in the field and become a more well rounded developer
          </p>
        </div>
        <div className=" h-1/2 w-1/2 flex flex-wrap pl-10 mt-10">
          <div className="bg-teal-950 rounded-2xl shadow-sm shadow-green-300 w-1/12 h-1/4 ml-10 flex text-center justify-center flex-wrap pt-1 hover:shadow-lg cursor-pointer">
